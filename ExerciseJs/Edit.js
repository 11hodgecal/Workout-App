...
async function editfinal()  {
    ...
    let id = window.localStorage.getItem("ForwardID")
    ...
    if (response.status == 204) {
        window.localStorage.removeItem("ForwardID")
...
async function EditPage(){
    ...
    if(result.type == "Endurance"){
       selected = `"<select name="type" id="inputtype" class="form-select" aria-label="Default select example"><option selected value="Endurance">Endurance</option><option value="Strength">Strength</option><option value="Balance">Balance</option><option value="Flexibility">Flexibility</option></select>"`
    }
    if(result.type == "Strength"){
        selected = `"<select name="type" id="inputtype" class="form-select" aria-label="Default select example"><option  value="Endurance">Endurance</option><option selected value="Strength">Strength</option><option value="Balance">Balance</option><option value="Flexibility">Flexibility</option></select>"`
    }
    if(result.type == "Balance"){
        selected = `"<select name="type" id="inputtype" class="form-select" aria-label="Default select example"><option  value="Endurance">Endurance</option><option value="Strength">Strength</option><option selected  value="Balance">Balance</option><option value="Flexibility">Flexibility</option></select>"`
    }
    if(result.type == "Flexibility"){
        selected = `"<select name="type" id="inputtype" class="form-select" aria-label="Default select example"><option  value="Endurance">Endurance</option><option value="Strength">Strength</option><option  value="Balance">Balance</option><option selected  value="Flexibility">Flexibility</option></select>"`
    }
